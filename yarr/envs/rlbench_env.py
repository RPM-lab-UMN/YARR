...
class RLBenchEnv(Env):
    ...
    def reset(self, seed=None, desc_index=0) -> dict:
        descriptions, obs = self._task.reset(seed)
        self._lang_goal = descriptions[desc_index] # first description variant
...
class MultiTaskRLBenchEnv(MultiTaskEnv):
    ...
    def reset(self, seed=None, interactive=False, desc_index=0) -> dict:
        ...
        self._lang_goal = descriptions[desc_index]
        extracted_obs = self.extract_obs(obs)
